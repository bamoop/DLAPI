...
type Token struct {
	...
	ClaudeCodeHeader   bool           `json:"claude_code_header"` // 增加 Claude code 请求头
...
func (token *Token) Update() (err error) {
	...
	err = DB.Model(token).Select("name", "status", "expired_time", "remain_quota", "unlimited_quota",
		"model_limits_enabled", "model_limits", "allow_ips", "group", "cross_group_retry", "claude_code_header").Updates(token).Error
	return err
}
